...
public class ERR_R {
    ...
    public ERR_R(String approachPath, String tagsOfSkillAreaPath, int rank) throws IOException {
        ReadClusteringFile(tagsOfSkillAreaPath);
        SaveUserShape(approachPath, rank);
        calculateERR(approachPath, rank);
    }
    ...
    private void SaveUserShape(String approachPath, int rank) throws IOException {
        for (String SAItem : SAList) {
            SaveUserShapeForTheSA(SAItem, approachPath, rank);
        }
    }

    private void SaveUserShapeForTheSA(String skillArea, String approachPath, int rank) throws FileNotFoundException, IOException {
    ...
    private void calculateERR(String approachPath, int rank) throws FileNotFoundException {
        PrintWriter writer = new PrintWriter(approachPath + "ERR_" + rank + ".csv");
